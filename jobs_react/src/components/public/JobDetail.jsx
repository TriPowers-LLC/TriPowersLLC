    ...
    <div className="space-y-6">
      ...
      <section className="space-y-4">
        ...
        <div className="flex gap-4 text-sm text-slate-700 flex-wrap">
          <span>Vendor: {selectedJob.vendorName || "N/A"}</span>
      ...
      <section className="bg-slate-50 border rounded-lg p-6">
        ...
        {!isAuthenticated ? (
          <div className="space-y-3">
            <p className="text-slate-700">
              Please log in or register as an applicant to apply for this job.
            </p>
            <div className="flex gap-3">
              <Link to="/login" className="px-4 py-2 bg-blue-700 text-white rounded">
                Log In
              </Link>
          ...
          <p className="text-slate-700">
            Only applicant accounts can submit applications.
          </p>
        ) : (
